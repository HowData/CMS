...
public class DateUtil
{
    ...
    /** 默认日期格式, yyyy-MM */
    public static String DEFAULT_MONTH_PATTERN = "yyyy-MM";

    /** 默认时间格式, yyyy-MM-dd hh24:mm:ss */
    public static String DEFAULT_TIME_PATTERN = "yyyy-MM-dd HH:mm:ss";
    
    /** 默认时间格式, yyyy-MM-dd hh24:mm */
    public static String DEFAULT_MIN_PATTERN = "yyyy-MM-dd HH:mm";
    ...
    public static List<String> getYearListByPara(Date date,boolean isAgo,int agoYearNum,boolean isAfter,
    int afterYearNum)
    {
        if (date == null)
            date = new Date();
